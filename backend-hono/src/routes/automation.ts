...
// checkAutomationCondition function removed - no longer needed for direct SMS integration
...
// Webhook endpoint removed - now using direct SMS integration in sheets.ts
