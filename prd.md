...
## 개요
구글 스프레드시트에 저장된 주문 정보를 관리자가 직접 관리하고, 배송담당자는 QR 코드와 본인 인증을 통해 자신의 배달 목록에 접근할 수 있는 간소화된 MVP 시스템입니다. 배달 완료시에만 고객에게 카카오톡 메시지를 자동 발송합니다.
...
9. **날짜별 스프레드시트에 배달 정보 입력**: 배송지, 고객명, 연락처, 배송담당자
